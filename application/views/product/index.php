...
<head>
    ...
    <link rel="icon" type="image/png" href="https://cdn.iconscout.com/icon/premium/png-256-thumb/product-management-19-1146665.png?f=webp&w=256">
    ...
    <div class="wrapper">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                <li><a href="home" class="activ"><i class="fas fa-home" style="margin-right: 5px;"></i> Home</a></li>
